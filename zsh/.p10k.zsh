# Generated by Powerlevel10k configuration wizard on 2025-06-11 at 21:51 CEST.
...
# 24h time, angled separators, round heads, flat tails, 1 line, compact, many icons,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%65F'   # muted grey-green foreground
      local   modified='%101F'  # muted olive foreground
      local  untracked='%66F'   # muted steel-blue foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=65
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=65
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=65
